...
public class TestDataReader {
    ...
    private static void init() {
        if (workbook == null) {
            ...
            try {
                fileInputStream = new FileInputStream("src/test/resources/Search data.xlsx");
            ...
            XSSFSheet sheet = workbook.getSheet("Search data");  //copy the name from excel sheet(sheet1)
